    ...
    <>
      ...
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <h2 class="mb-4 flex items-center p-2 text-3xl font-bold text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            E Commerce
          </h2>
          ...
          <ul class="space-y-2 font-medium">
            ...
            <h2 class="mb-4 flex items-center p-2 font-bold text-gray-400 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ECOMMERCE COMPONENT
            </h2>
            <li>
              <a
                  ...
                  <div class="collapse multi-collapse" id="dropDown">
                    <div class="visible m-3">
                      ...
                      <a
                        ...
                        class="flex items-center text-gray-900 rounded-lg dark:text-white hover:bg-stone-300 rounded-s-md p-2 dark:hover:bg-gray-700 group"
                      >
                        <div class="flex-1 whitespace-nowrap">Item 2</div>
                      </a>
                      <a
                        href="#"
                        class="flex items-center text-gray-900 rounded-lg dark:text-white hover:bg-stone-300 rounded-s-md p-2 dark:hover:bg-gray-700 group"
                      >
                        <div class="flex-1 whitespace-nowrap">Item 3</div>
                      </a>
                    </div>
                  </div>
                </div>
